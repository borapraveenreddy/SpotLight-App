...
export const createPost = mutation({
    ...
    handler : async(ctx , args) => {
       ...
       const postId =  await ctx.db.insert("posts", {
        ...
        //increment no. of posts of the user
...
export const getFeedPosts = query({
    handler : async(ctx) => {
        ...
        // get all posts of the users that the current user follows
        ...
        const postsWithInfo = await Promise.all(
            posts.map(async(post) => {
                ...
                // console.log(`Post ${post._id} userId: ${post.userId}`);
                // console.log(`Author data:`, postAuthor);
...
export const deletePost = mutation({
    ...
    handler: async (ctx , args) => {
        ...
        //delete post and its other database like likes,comments,notifications
