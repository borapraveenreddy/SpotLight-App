import { View , Text, StyleSheet, TouchableOpacity, ScrollView, FlatList, Modal, Keyboard, KeyboardAvoidingView, Platform, TextInput} from "react-native";
...
export default function profile(){
  ...
  const currentUser = useQuery(api.users.getUderByClerkId, userId ? {clerkId: userId } : "skip");
